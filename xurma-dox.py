...
{Fore.YELLOW}If the tool is not returning results then visit {Fore.WHITE}[https://thatsthem.com]{Fore.YELLOW} You will
  then be prompted with a human verification so complete it, and then the tool
    will return results again. If the tool is still not finding results then
       that means there was no information on the target in the database.{Fore.CYAN}
''')
